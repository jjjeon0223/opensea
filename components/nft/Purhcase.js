...
import { IdMdWallet, IoMdWallet } from "react-icons/io";
...
function Purhcase({ isListed, selectedNft, listings, marketPlaceModule }) {
    ...
    <div className="bg-[#303339] h-20 w-full flex items-center px-12 rounded-lg border-[#151c22]">
      ...
      {isListed === "true" ? (
        <>
          ...
          <div className={`${style.button} border border-[#151c22]`}>
